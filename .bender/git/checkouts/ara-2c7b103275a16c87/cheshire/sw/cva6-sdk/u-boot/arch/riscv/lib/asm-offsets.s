...
# options passed: -mabi=lp64 -mcmodel=medlow -misa-spec=20191213 -march=rv64imac_zicsr_zifencei -g -gdwarf-2 -Os -std=gnu11 -fstack-protector-strong -fno-builtin -ffreestanding -fshort-wchar -fno-strict-aliasing -fno-stack-protector -fno-delete-null-pointer-checks -fstack-usage -ffixed-gp -fpic -fno-common -ffunction-sections -fdata-sections
	.text
.Ltext0:
	.file 1 "arch/riscv/lib/asm-offsets.c"
...
.LFB132:
	...
	.loc 1 17 2
#APP
# 17 "arch/riscv/lib/asm-offsets.c" 1
	
.ascii "->GD_BOOT_HART 320 offsetof(gd_t, arch.boot_hart)"	#
# 0 "" 2
	.loc 1 18 2
# 18 "arch/riscv/lib/asm-offsets.c" 1
	
.ascii "->GD_FIRMWARE_FDT_ADDR 328 offsetof(gd_t, arch.firmware_fdt_addr)"	#
# 0 "" 2
	.loc 1 20 2
# 20 "arch/riscv/lib/asm-offsets.c" 1
	
.ascii "->GD_AVAILABLE_HARTS 336 offsetof(gd_t, arch.available_harts)"	#
# 0 "" 2
	.loc 1 23 2
# arch/riscv/lib/asm-offsets.c:24: }
...
.LASF13:
	.string	"arch/riscv/lib/asm-offsets.c"
.LASF1:
	.string	"char"
.LASF3:
	.string	"long int"
